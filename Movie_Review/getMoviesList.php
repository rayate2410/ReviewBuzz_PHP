...
//Query to fetch list of movies based on search parameter.
$query1 = "select * from movie_info where movie_name like '$movie_name%' order by Movie_release_Date DESC";
